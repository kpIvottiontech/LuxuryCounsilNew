...
void main() => runApp(ShareToSocial());

class ShareToSocial extends StatefulWidget {
  @override
  _ShareToSocialState createState() => _ShareToSocialState();
}

class _ShareToSocialState extends State<ShareToSocial> {
  File? file;
